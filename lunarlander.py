...
from ops import get_agent_cls_lunar


def build_and_train(env_id="LunarLander-v2", run_ID=0, cuda_idx=None,
    ...
    agentCls, agent_basis = get_agent_cls_lunar(args.network)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--folder', help='Folder to store results',
                        default='LunarLanderExperiment')
    parser.add_argument('--env_id', help='Gym', default='LunarLander-v2')
