...
from ops import get_agent_cls_pvz
import gympvz.gym_pvz

def build_and_train(env_id="pvz-env-v2", run_ID=0, cuda_idx=None,
    ...
    agentCls, agent_basis = get_agent_cls_pvz(args.network)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--folder', help='Folder to store results',
                        default='pvzExperiment')
    parser.add_argument('--env_id', help='Gym', default='pvz-env-v2')
