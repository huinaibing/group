...
from ops import get_agent_cls_race
...
def build_and_train(env_id="mars-explorer-v1", run_ID=0, cuda_idx=None,
    ...
    agentCls, agent_basis = get_agent_cls_race(args.network)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env_id', help='Grid', default='mars-explorer-v1')
